...
public static class Logging
{
    ...
    public static string ResolvedDirectory{get;private set;}=Directory.GetCurrentDirectory();
    public static string Setup(string? directory=null)
    {
        var dir=directory??DefaultDirectory();ResolvedDirectory=dir;Directory.CreateDirectory(dir);var path=Path.Combine(dir,FileName);
